    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
        <View style={styles.headerSection}>
          ...
          <Text style={styles.subtitle}>Log in to manage your bookings and track technicians on Karigar</Text>
        </View>
        ...
        <View style={styles.roleSelectionGroup}>
          ...
          >
            <Icon name="briefcase-outline" size={26} color={role === "CLIENT" ? theme.colors.primary : "#777"} style={{ marginBottom: 4 }} />
            <Text style={[styles.roleBlockTitle, role === "CLIENT" && styles.roleTextActive]}>Client Login</Text>
          </TouchableOpacity>
          ...
          >
            <Icon name="hammer-outline" size={26} color={role === "TECHNICIAN" ? theme.colors.primary : "#777"} style={{ marginBottom: 4 }} />
            <Text style={[styles.roleBlockTitle, role === "TECHNICIAN" && styles.roleTextActive]}>Technician Login</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: theme.typography.fontSizes.sm, color: theme.colors.textSecondary, lineHeight: 20 },
  roleSelectionGroup: { flexDirection: "row", gap: 12, marginBottom: theme.spacing.xl },
  roleBlockCard: { flex: 1, backgroundColor: theme.colors.surface, borderRadius: 16, paddingVertical: theme.spacing.md, alignItems: "center", borderWidth: 1, borderColor: theme.colors.border },
  roleBlockActive: { backgroundColor: theme.colors.surface, borderColor: theme.colors.primary, borderWidth: 2 },
  roleBlockTitle: { fontSize: 13, fontWeight: theme.typography.fontWeights.bold, color: theme.colors.textSecondary },
  roleTextActive: { color: theme.colors.primary },
  formSection: { width: "100%" },
  loginButton: { marginTop: theme.spacing.md, marginBottom: theme.spacing.xl, borderRadius: 12 },
  switchAuthText: { textAlign: "center", color: theme.colors.textSecondary, fontSize: theme.typography.fontSizes.sm },
  link: { color: theme.colors.primary, fontWeight: theme.typography.fontWeights.bold },
});